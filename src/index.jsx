		...
		questions: [
			{
				...
				children: [
					...
					},
					{
						...
						more:
							'Plug-in electric vehicles (also known as electric cars or EVs) can save you money, with much lower fuel costs on average than conventional gasoline vehicles. ... While the operating costs of EVs are substantially lower, EVs can be more expensive to purchase than their conventional counterparts.May 25, 2019',
			...
			},
			{
				...
				children: [
					...
					},
					{
						...
						more:
							'List of EVs by price Hyunda Ioniq Electric $44,990 Hyunda Kona Electric $59,990 BMW i3 $68,400 Tesla Model S $115,000 Tesla Model X $165,000 3 more rows\u2022Apr 22, 2019',
					...
					},
					{
						...
						more:
							'Electric Cars Are Estimated to Be Cheaper Than Regular Cars by 2022. Electric cars have developed a reputation as the ultimate status symbol of the champagne environmentalist, but that could be very close to changing. New research from BloombergNEF says they could be cheaper than combustion-engine cars by 2022.Apr 29, 2019',
						url:
							'https://singularityhub.com/.../electric-cars-are-estimated-to-be-cheaper-than-regular-cars-...',
						parent: 'Which electric car is the cheapest?',
						children: []
					},
					{
			...
			},
			{
				...
				children: [
					...
					},
					{
						...
						more:
							'8 Best Electric Cars for 2019: Reviews, Photos, and More Mitsubishi i-MIEV. Chevrolet Bolt EV. Chevrolet Spark EV. Ford Focus Electric. Tesla Model S. BMW i3. Mercedes-Benz B-Class. Nissan LEAF. Mar 6, 2019',
...
import './style.css';
import { Header, Icon, Input, Container, Segment, Button, List, Grid, Divider, Label, Popup } from 'semantic-ui-react';
...
class App extends React.Component {
	...
	render() {
		...
		// 	// FIRST CHILD
		// 	Object.entries(data.group1.questions[0].children).forEach(([ key, value ]) => {
		// 		firstSearchChildren.push(
		// 			<List.Item className="my_list_v1">
					// 	<List.Content>
					// 		<List.Header>{data.group1.questions[0].children[key].search}</List.Header>
					// 		<List.Description>{data.group1.questions[0].children[key].more}</List.Description>
					// 		<br />
					// 		<List.Description>
					// 			<Label
					// 				as="a"
					// 				href={data.group1.questions[0].children[key].url}
					// 				target="_blank"
					// 				color="blue"
					// 				size="large"
					// 			>
		...
		// 	// SECOND CHILD
		// 	secondSearchParent.push(
		// 		data.group1.questions[1].search,
		// 		data.group1.questions[1].more,
		// 		data.group1.questions[1].url
		// 	);

		// 	Object.entries(this.state.response.group1.questions[1].children).forEach(([ key, value ]) => {
		// 		secondSearchChildren.push(
		// 			<li>
		// 				{data.group1.questions[1].children[key].search}, {data.group1.questions[1].children[key].more},{' '}
		// 				{data.group1.questions[1].children[key].url}{' '}
		// 			</li>
		// 		);
		// 	});
		// }
